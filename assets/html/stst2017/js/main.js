jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2017, 2, 27, 15)}); // enter event day
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(50.8778789, 4.7005215), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(50.8778789, 4.7005215) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Student Startup Forum 2017</b><br/>Naamsestraat 22<br/>3000 Leuven"  //add your address
    });
